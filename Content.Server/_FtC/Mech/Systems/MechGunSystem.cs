...
using Content.Shared._FtC.Mech.Equipment.Components;
using Content.Shared._FtC.Weapons.Ranged.Components;
using Content.Shared.Mech;
using Content.Shared._FtC.Mech;
using Robust.Shared.Timing;
using Robust.Server.Audio;
using Content.Server._FtC.Mech.Equipment.Components;

namespace Content.Server._FtC.Mech.Equipment.EntitySystems;
public sealed class MechGunSystem : EntitySystem
{
    ...
    private void OnUiStateReady(EntityUid uid, BallisticMechAmmoProviderComponent component, MechEquipmentUiStateReadyEvent args)
    {
        ...
        {
            Relo_FtCime = component.Relo_FtCime,
    ...
    private void OnReload(EntityUid uid, BallisticMechAmmoProviderComponent comp, MechEquipmentUiMessageRelayEvent args)
    {
        ...
        comp.Reloading = true;
        comp.ReloadEnd = _timing.CurTime + TimeSpan.FromSeconds(comp.Relo_FtCime);

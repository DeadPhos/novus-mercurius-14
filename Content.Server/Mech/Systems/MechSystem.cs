...
public sealed partial class MechSystem : SharedMechSystem
{
    ...
    public override void Initialize()
    {
        ...
        // SubscribeLocalEvent<MechPilotComponent, InhaleLocationEvent>(OnInhale);  // _FtC Commented
        ...
        // SubscribeLocalEvent<MechComponent, MechGrabberEjectMessage>(ReceiveEquipmentUiMesssages);    // _FtC - Moved to Shared
        // SubscribeLocalEvent<MechComponent, MechSoundboardPlayMessage>(ReceiveEquipmentUiMesssages);  // _FtC - Moved to Shared
        #endregion

        Initialize_FtC();    // _FtC tweak
    }
    ...
    private void OnRemoveEquipmentMessage(EntityUid uid, MechComponent component, MechEquipmentRemoveMessage args)
    {
        ...
        UpdateUserInterface(uid);   // _FtC Mech
    }
    ...
    // private void OnInhale(EntityUid uid, MechPilotComponent component, InhaleLocationEvent args) // _FtC - Moved to shared
    // {
    ...
    private void OnExpose(EntityUid uid, MechPilotComponent component, ref AtmosExposedGetAirEvent args)
    {
        ...
        {
            args.Handled = true;
            args.Gas = mech.Airtight ? air.Air : _atmosphere.GetContainingMixture(component.Mech);  // _FtC Tweak
            return;
        }

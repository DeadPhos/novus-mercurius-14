...
public sealed class MechGrabberSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<MechGrabberComponent, EntityTerminatingEvent>(OnTerminating);   // _FtC Mech
    }
    ...
    // _FtC Mech start
    private void OnTerminating(EntityUid uid, MechGrabberComponent comp, ref EntityTerminatingEvent args)   // _FtC
    {

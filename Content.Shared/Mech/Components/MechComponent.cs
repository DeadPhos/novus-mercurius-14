...
public sealed partial class MechComponent : Component
{
    ...
    /// </summary>
    [DataField("maxintegrity"), AutoNetworkedField, ViewVariables(VVAccess.ReadWrite)]  // _FtC Mech
    ...
    /// </summary>
    [DataField("equipmentWhitelist")]   // _FtC Mech
    ...
    public SoundSpecifier MechEntrySound = new SoundPathSpecifier("/Audio/_FtC/Mecha/nominal.ogg");
    /// <summary>
    /// sound on turn lights
    /// </summary>
    [DataField("mechlightoffsound")]
    public SoundSpecifier MechLightsOnSound = new SoundPathSpecifier("/Audio/_FtC/Mecha/mechlignton.ogg");
    [DataField("mechlightonsound")]
    public SoundSpecifier MechLightsOffSound = new SoundPathSpecifier("/Audio/_FtC/Mecha/mechlightoff.ogg");
    /// <summary>
    /// sound on destroy equipment
    /// </summary>
    [DataField("mechequipmentdestr")]
    public SoundSpecifier MechEquipmentDestr = new SoundPathSpecifier("/Audio/_FtC/Mecha/weapdestr.ogg");

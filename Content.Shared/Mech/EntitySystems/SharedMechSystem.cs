...
/// </summary>
public abstract partial class SharedMechSystem : EntitySystem   // _FtC - partial
{
    ...
    {
        // SubscribeLocalEvent<MechComponent, MechToggleEquipmentEvent>(OnToggleEquipmentAction);// _FtC Commented
    ...
    public virtual bool TryChangeEnergy(EntityUid uid, FixedPoint2 delta, MechComponent? component = null)
    {
        ...
        // if (component.Energy + delta < 0)    // _FtC Commented

            ...
            switch (shootable)
            {
                case CartridgeAmmoComponent cartridge:
                    if (!cartridge.Spent)
                    {
                        ...
                        if (TryComp<MechComponent>(user, out var cmech))    // _FtC Mechs
                        {
                ...
                case AmmoComponent newAmmo:
                    ...
                    if (TryComp<MechComponent>(user, out var mech)) // _FtC Mechs
                    {
                ...
                case HitscanPrototype:
                    if (TryComp<MechComponent>(user, out var hmech)) // _FtC Mechs
                    {
